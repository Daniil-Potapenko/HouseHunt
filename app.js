...
app.post(
    '/uploads',
    PictureController.upload.single('image'),
    PictureController.returnPathOfImage,
);
...
app.post(
    ...
    ResidentialComplexController.createResidentialComplex,
);
app.get(
    '/data/residentialComplex',
    ResidentialComplexController.findResidentialComplex,
);
app.get(
    '/data/allResidentialComplex',
    ResidentialComplexController.findAllResidentialComplexInCity,
);
app.delete(
    '/data/residentialComplex',
    ResidentialComplexController.deleteResidentialComplex,
);
